...
const required = ['LICENSE', 'README.md', 'bin/gws.js', 'src/index.d.ts', 'src/index.js', 'src/providers/index.d.ts', 'src/providers/index.js', 'src/node/index.d.ts', 'src/node/index.js', 'schemas/source-record.schema.json', 'schemas/synthesis-result.schema.json'];
